...
saveRDS(results, file = "Current code/Control Meausres/Vaccination/Indirect is DT by 500/LT_80VaccEff.rds")
results <- readRDS(file = "Current code/Control Meausres/Vaccination/Indirect is DT by 178/LT_80VaccEff.rds")
### Reporting Values ####
