...
for (i in c(1:n.itr)) {
  ...
  TransmissionModel.Int.4to5 <- c(
    ...
    #Room3
    S3 = round((1-Hog_Vacc_Eff )*999, digits = 0),
    E3 = 0,
    I3 = 1,
    R3 = round(Hog_Vacc_Eff *999, digits = 0),
    Total_inf3 = 0,
    True_Rec3 = 0,
    D3_Nat = 0,
    D3_Inf = 0,
...
saveRDS(results, file = "Current code/Reviewer Update Code and Models/WF Flow/Indirect by 178/R10_Room3_60VaccEff.rds")
...
results %>% 
  ...
  ungroup() %>% 
  summarise(med_t_cross = median(min_t_cross) - 28,
            LB_t_cross = quantile(min_t_cross, probs = 0.05) - 28,
            UB_t_cross = quantile(min_t_cross, probs = 0.95) - 28)
...
results %>% 
  ...
  ungroup() %>% 
  summarise(med_t_peak = median(min_t_peak) - 28,
            LB_t_peak = quantile(min_t_peak, probs = 0.05) - 28,
            UB_t_peak = quantile(min_t_peak, probs = 0.95) - 28)
